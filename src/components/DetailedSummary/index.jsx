  ...
  const fetchDetailedSummary = async () => {
    try {
      ...
      const response = await fetch(
        `https://nissan-backend.onrender.com/api/detailed-summary?category=${encodeURIComponent(category)}&models=${encodeURIComponent(models)}&date=${encodeURIComponent(date)}&brand=${encodeURIComponent(brand)}`
      );
